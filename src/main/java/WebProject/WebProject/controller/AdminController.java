...
public class AdminController {
	...
	public String SignInAdminHandel(@ModelAttribute("login-name") String login_name,
		...
		if (admin == null) {
			session.setAttribute("err_sign_admin", "TÀI KHOẢN HOẶC MẬT KHẨU CHƯA CHÍNH XÁC!");
	...
	public String SendMessage(Model model, @ModelAttribute("message") String message,
		...
		Mail mail = new Mail();
		mail.setMailFrom("bilakmkiss@gmail.com");
		mail.setMailTo(email);
		mail.setMailSubject("This is message from T&Pfashion.");
